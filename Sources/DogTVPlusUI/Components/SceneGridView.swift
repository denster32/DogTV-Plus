...
struct SceneGridView: View {
    ...
    private struct CurrentSceneView: View {
        ...
        var body: some View {
            ...
            .accessibilityLabel("Currently playing scene: \(scene.name)")
            .accessibilityHint("Double tap to pause or stop the scene.")
        }
        
        private var sceneColor: Color {
            switch scene.type {
            case .ocean: return .dogCalm
            case .forest: return .green
            case .fireflies: return .yellow
            case .rain: return .blue
            case .sunset: return .dogPlayful
    ...
    private struct SceneCollectionView: View {
        ...
        var body: some View {
            ...
            .accessibilityHint("Navigate to choose a scene to play.")
        }
    }
}
